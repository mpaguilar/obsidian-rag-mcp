...
class TestGetTasksServerWrapper:
    ...
    def test_server_wrapper_passes_tag_filters(self, mock_handler, mock_registry):
        ...
        get_tasks(status=["not_completed"], tag_filters=tag_filters)
    ...
    def test_server_wrapper_default_tag_filters(self, mock_handler, mock_registry):
        ...
        get_tasks(status=["not_completed"])
...
class TestGetTasksJsonString:
    ...
    def test_get_tasks_accepts_json_string(self, mock_handler, mock_registry):
        """Test that get_tasks accepts JSON string tag_filters."""
        mock_registry_instance = MagicMock()
        mock_registry.return_value = mock_registry_instance
        ...
        json_params = '{"include_tags": ["work"], "match_mode": "any"}'
        result = get_tasks(tag_filters=json_params, limit=10)
    ...
    def test_get_tasks_accepts_dict(self, mock_handler, mock_registry):
        """Test that get_tasks accepts dict date_filters."""
        mock_registry_instance = MagicMock()
        mock_registry.return_value = mock_registry_instance
    ...
    def test_get_tasks_accepts_none(self, mock_handler, mock_registry):
        """Test that get_tasks with no args uses defaults."""
        mock_registry_instance = MagicMock()
        mock_registry.return_value = mock_registry_instance
        ...
        result = get_tasks(tag_filters=None, date_filters=None)
    ...
    def test_get_tasks_json_with_nested_filters(self, mock_handler, mock_registry):
        ...
        json_params = '{"include_tags": ["work", "urgent"], "match_mode": "all"}'
        result = get_tasks(
            status=["not_completed"],
            tag_filters=json_params,
        )
    ...
    @patch("obsidian_rag.mcp_server.server._get_registry")
    @patch("obsidian_rag.mcp_server.handlers._get_tasks_handler")
    def test_get_tasks_with_dataclass_filters(self, mock_handler, mock_registry):
        """Test that get_tasks accepts dataclass filters directly."""
        mock_registry_instance = MagicMock()
        mock_registry.return_value = mock_registry_instance
